                ...
                <div className="modal-overlay" style={{
                    ...
                    >
                        ...
                        <div className="d-flex flex-column gap-3">
                            <a
                                href={(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') && !window.navigator.userAgent.includes('ReactSnap') ? 'http://localhost:3001/login' : 'https://consult.koneacademy.io/login'}
