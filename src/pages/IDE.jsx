            ...
            <div className={`flex-grow-1 d-flex flex-column overflow-hidden ${isMobile && mobileTab === 'explorer' ? 'd-none' : ''}`} style={{ minWidth: 0, height: '100%', flexGrow: 1 }}>
                ...
                <div className="d-flex justify-content-between align-items-center border-bottom px-2" style={{ backgroundColor: '#2d2d2d', borderColor: '#1e1e1e', height: isMobile ? 'auto' : '40px', minHeight: '40px', flexWrap: 'nowrap', padding: '5px 0', overflowX: isMobile ? 'auto' : 'visible' }}>
                    ...
                    <div className="d-flex align-items-center gap-1 gap-md-2">
                            ...
                            <AnimatePresence>
                                {isHelpOpen && (
                                    ...
                                    >
                                        ...
                                        <a 
                                            href={((window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') && !window.navigator.userAgent.includes('ReactSnap') ? 'http://localhost:3001' : 'https://consult.koneacademy.io') + "/docs?category=code"} 
                                            target="_blank" 
                                            rel="noreferrer"
                                        ...
                                        <a href={((window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') && !window.navigator.userAgent.includes('ReactSnap') ? 'http://localhost:3001' : 'https://consult.koneacademy.io') + "/contact"} target="_blank" rel="noopener noreferrer" className="d-flex align-items-center gap-2 px-3 py-2 text-white hover-bg-light-opacity text-decoration-none" style={{ fontSize: '13px' }}>
                                            <FaCommentAlt size={14} className="text-info" /> Feedback
                                        </a>
                                        <a href={((window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') && !window.navigator.userAgent.includes('ReactSnap') ? 'http://localhost:3001' : 'https://consult.koneacademy.io') + "/training"} target="_blank" rel="noopener noreferrer" className="d-flex align-items-center gap-2 px-3 py-2 text-white hover-bg-light-opacity text-decoration-none" style={{ fontSize: '13px' }}>
                        ...
                        {currentUser ? (
                            <a href={((window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') && !window.navigator.userAgent.includes('ReactSnap') ? 'http://localhost:3001' : 'https://consult.koneacademy.io') + "/profile"} className="text-secondary hover-text-white d-flex align-items-center ms-1">
                                <FaUserCircle size={18} />
                            </a>
                        ) : (
                            <a href={(window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') && !window.navigator.userAgent.includes('ReactSnap') ? 'http://localhost:3001/login' : 'https://consult.koneacademy.io/login'} className="btn btn-primary border-0 ms-1" style={{ fontSize: '11px', height: '24px', padding: '0 10px', backgroundColor: '#007acc' }}>
                                Login
                            </a>
                        )}
                    </div>
